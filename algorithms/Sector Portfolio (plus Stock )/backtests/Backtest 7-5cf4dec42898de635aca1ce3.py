...
def get_sector_weights(context, data):
    ...
    if not alpha.empty:
        ...
        for s in context.assets:
            sector_name = context.sector_names[s]
            if q_sector_wts[s] < 0:
                context.min_sector_weights[sector_name] = q_sector_wts[s]
                context.max_sector_weights[sector_name] = 0
            elif q_sector_wts[s] == 0:
                context.min_sector_weights[sector_name] = 0
                context.max_sector_weights[sector_name] = 0
            elif q_sector_wts[s] > 0:
                context.min_sector_weights[sector_name] = 0
                context.max_sector_weights[sector_name] = q_sector_wts[s]
...
def rebalance(context, data):
    ...
    if not alpha.empty:
        ...
        min_sector_wts = context.min_sector_weights
        max_sector_wts = context.max_sector_weights
