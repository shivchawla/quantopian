...
def make_pipeline():
    ...
    f96 = FnCTa_mean(mask = base_universe)
...
def before_trading_start(context, data):
    ...
    alpha_99 = output['f99']
    alpha_100 = output['f100']
    alpha_101 = output['f101']
    
    alpha_102 = output['f102']
    alpha_103 = output['f103']
    
    alpha_104 = output['f104']
    alpha_105 = output['f105']
    alpha_106 = output['f106']

    alpha_107 = output['f107']
    alpha_108 = output['f108']
    alpha_109 = output['f109']
    alpha_110 = output['f110']
    
    alpha_111 = output['f111']
    alpha_112 = output['f112']
    ...
    alpha =  alpha_4 + alpha_52 + alpha_s3 + alpha_k6 + alpha_54 + alpha_86 + alpha_91 + alpha_94 + alpha_95 + alpha_98 + alpha_99 + alpha_100 + alpha_101 + alpha_102 + alpha_103 + alpha_105 + alpha_106 + alpha_107 + alpha_108 + alpha_109 + alpha_110 + alpha_111
