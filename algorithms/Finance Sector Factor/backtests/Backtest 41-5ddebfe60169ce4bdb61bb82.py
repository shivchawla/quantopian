...
def before_trading_start(context, data):
    ...
    alpha = alpha_k6 + alpha_54*output['d1'] + alpha_4*output['d2'] + (alpha_54 + alpha_78)*output['d3'] + (alpha_s3 + alpha_52)*output['d4']

    # alpha =  alpha_4 + alpha_52 + alpha_s3 + alpha_78 + alpha_k6 + alpha_54 
