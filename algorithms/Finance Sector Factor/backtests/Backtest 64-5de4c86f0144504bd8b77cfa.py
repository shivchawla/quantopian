...
def before_trading_start(context, data):
    ...
    alphaI4_d2 = alphaI4 * output['d2'] #DivIncmTa_mean
    ...
    alphaI16_d3 = alphaI16 * output['d1']
    alphaI17_d4 = alphaI17 * output['d4']
    alphaI18_d5 = alphaI18 * output['d5']
    alphaI19_d1 = alphaI19 * output['d1']
    alphaI20_d2 = alphaI20 * output['d2']
    alphaI22_d2 = alphaI22 * output['d2']

    alpha = alpha_4_d2 +  alpha_52_d6 +  alpha_k6 +  \
alpha_54_d6 +  alpha_s3_d4 +  alpha_86_d2 +  alphaI1 +  alphaI4_d2 +  \
alphaI5_d6 +  alphaI8_d4 +  alphaI9_d4 +  alphaI10_d3 +  \
alphaI11 +  alphaI12_d4 +  alphaI13_d4 +  alphaI14_d3 + alphaI15_d3 +   alphaI16_d3 +  \
alphaI17_d4 +  alphaI18_d5 +  alphaI19_d1 +  alphaI20_d2 +  alphaI21 + alphaI22_d2                                    
