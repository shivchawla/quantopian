...
def before_trading_start(context, data):
    ...
    alpha = alpha_4_d2 + alpha_52_d6 + alpha_54_d6 + alpha_86_d2 +  alphaI1 + alphaI5_d6 +  alphaI8_d4 +  alphaI9_d4 +  alphaI11 + alphaI12_d4 +  alphaI13_d4 +  alphaI14_d3 + alphaI15_d3 + alphaI17_d4 +  alphaI18_d5  +  alphaI20_d4 +  alphaI21 + alphaI22_d2 + alphaI19_d1 + alphaI10_d3 + alphaI16_d1 + alpha_k6                                   
