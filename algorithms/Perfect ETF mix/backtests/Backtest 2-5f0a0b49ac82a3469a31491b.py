...
def closepositions(context,data):
    ...
    print("Delta")
    print(delta)
    order_target_percent(context.QQQ, (1/2)*(lev + delta))
    order_target_percent(context.TOT, (1/2)*(lev + delta))
    order_target_percent(context.SPY, (-lev + delta)/2)
    ...
    # and context.eod == False:
        ...
        # or (context.vol > 0.03 and r > 1.01): 
            ...
            if nOrdersQQQ == 0 and nOrdersSPY == 0:
                ...
                order_target_percent(context.TOT, (1/3)*(lev + delta))
                order_target_percent(context.SPY, (-lev + delta)/2)
                order_target_percent(context.VAL, (-lev + delta)/2)
