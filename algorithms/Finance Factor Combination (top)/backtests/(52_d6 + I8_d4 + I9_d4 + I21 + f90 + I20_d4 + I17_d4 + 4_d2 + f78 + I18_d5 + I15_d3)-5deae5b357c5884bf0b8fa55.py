...
def before_trading_start(context, data):
    ...
    alpha = (alpha_52_d6 + alphaI8_d4 + alphaI9_d4 + alphaI21 + output['f90'] + alphaI20_d4 + alphaI17_d4 + alpha_4_d2 + output['f78'] + alphaI18_d5 + alphaI15_d3)
    
    print (alpha_52_d6 + alphaI8_d4 + alphaI9_d4 + alphaI21 + output['f90'] + alphaI20_d4 + alphaI17_d4 + alpha_4_d2 + output['f78'] + alphaI18_d5).corr(alphaI15_d3)
