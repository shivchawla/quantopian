...
def before_trading_start(context,data): 
    ...
    fundamental_df = get_fundamentals(
        ...
        .filter(fundamentals.valuation.market_cap > 100000000) # cap > $30MM
        ...
        .order_by(fundamentals.valuation_ratios.cash_return.desc()).limit(50))
        #.order_by(fundamentals.valuation.market_cap.desc()).limit(50)).tail(50)
