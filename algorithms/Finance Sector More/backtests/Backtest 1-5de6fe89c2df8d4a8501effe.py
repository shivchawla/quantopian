...
def before_trading_start(context, data):
    ...
    alpha =  output['f1a'] +  output['f3b'] +  output['f4b'] +  output['f5'] + output['f7'] +  output['f9a'] +  output['f10'] +  output['f11a'] +  output['f12'] + output['f13a'] +  output['f13c'] +  output['f14a'] +  output['f14b'] + output['f15'] + output['f16'] +  output['f17a'] +  output['f19a'] +  output['f19b'] + output['f21'] +  output['f27'] +  output['f28b'] + output['f30']   
