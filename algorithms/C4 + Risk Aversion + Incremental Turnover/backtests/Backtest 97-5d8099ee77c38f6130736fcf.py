...
'fqn8_sales_yield_cons']].std(axis=1)
    ...
    alpha_c = (alpha1_c + alpha2_c + alpha3_c + alpha6_c + alpha38 + alpha39 + alpha34 + alpha36 + alpha40)/9 
    
    # alpha_c = alpha1_c + alpha2_c + alpha3_c + alpha6_c + alpha38 + alpha39 + alpha34 + alpha36 + alpha40
    
    alpha_c = (alpha_c - alpha_c.mean())/alpha_c.std()
