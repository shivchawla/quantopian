...
#W
    ...
    alpha_c = (alpha1_c + alpha2_c + alpha3_c + alpha6_c + alpha38 + alpha39 + alpha34)/7 
    
    # alpha_c1 = alpha_c1.sub(alpha_c1.mean())
    # alpha_c2 = alpha_c2.sub(alpha_c2.mean())
    
    # alpha_K1 = (alpha_c1 + alpha_c2)/2
    
    # alpha_K2 = (alpha_c + alpha_c1 + alpha_c2)/3
