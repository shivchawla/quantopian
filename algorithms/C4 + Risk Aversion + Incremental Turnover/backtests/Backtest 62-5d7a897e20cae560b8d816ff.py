...
def before_trading_start(context, data):
    ...
    alpha3_c = signalize(signalize(output['fq1_sales_mean']/output['fq1_sales_std']).dropna()*vol_rank) 
    ...
    alpha12_c = signalize(signalize(output['price_tgt_mean']/output['price_tgt_std'])*vol_rank).dropna()
    ...
    alpha_c = (alpha1_c + alpha2_c + alpha3_c + alpha6_c + alpha10_c + alpha12_c)/6 
