...
def before_trading_start(context, data):
    ...
    # for k in alphas.columns:
        # print k
        # alphas = alphas.sort_values(by=[k])
        # print alphas[k]
        # alphas.loc[:50, k] = 0
        # alphas.loc[-50:, k] = 0
    ...
    context.combined_alpha = context.combined_alpha.sort_values()    
    context.combined_alpha[:50] = 0
    context.combined_alpha[-50:] = 0
    
    # print context.combined_alpha
