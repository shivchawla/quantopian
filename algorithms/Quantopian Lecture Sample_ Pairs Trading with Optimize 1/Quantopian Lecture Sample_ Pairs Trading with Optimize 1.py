...
def initialize(context):
    ...
    # set_symbol_lookup_date('2019-01-01')
    
    context.stock_pairs = [(symbol('TQQQ'), symbol('WEBL')),
                           (symbol('TQQQ'), symbol('TECL')),
                          (symbol('TECL'), symbol('WEBL'))]
    
    context.stocks = symbols('TQQQ', 'WEBL', 'TECL')
