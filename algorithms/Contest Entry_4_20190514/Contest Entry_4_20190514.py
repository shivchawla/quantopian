...
def initialize(context):
    ...
    context.min_beta = 0.95
    context.max_beta = 1.05
    context.max_net_exposure = 1.005
    context.max_volatility = 0.05
    algo.set_benchmark(sid(41382))
...
def before_trading_start(context, data):
    ...
    output['rand'] = np.random.rand(output.shape[0], 1)
    ...
    alpha16 = transform(output, 'rand', 1)
    ...
    ra = alpha1 + alpha2 + alpha3 + s1 + alpha9 + alpha10 + alpha13 + alpha14 + alpha15 + alpha16
