...
def make_pipeline():
    ...
    fq0_ev = Previous([ev], window_length=1)
    fqn1_ev = Previous([ev], window_length=1*66)
    fqn2_ev = Previous([ev], window_length=2*66)
    fqn3_ev = Previous([ev], window_length=3*66)
    fqn4_ev = Previous([ev], window_length=4*66)
    fqn5_ev = Previous([ev], window_length=5*66)
    fqn6_ev = Previous([ev], window_length=6*66)
    fqn7_ev = Previous([ev], window_length=7*66)
    fqn8_ev = Previous([ev], window_length=8*66)
...
'guid_sales_to_mcap_qn6', 'guid_sales_to_mcap_qn7']]
    ...
    output['guid_sales_to_ev_q1'] = output['fq0_ev']/output['fq1_sales_guid']
    output['guid_sales_to_ev_q0'] = output['fqn1_ev']/output['fq0_sales_guid']
    output['guid_sales_to_ev_qn1'] = output['fqn2_ev']/output['fqn1_sales_guid']
    output['guid_sales_to_ev_qn2'] = output['fqn3_ev']/output['fqn2_sales_guid']
    output['guid_sales_to_ev_qn3'] = output['fqn4_ev']/output['fqn3_sales_guid']
    output['guid_sales_to_ev_qn4'] = output['fqn5_ev']/output['fqn4_sales_guid']
    output['guid_sales_to_ev_qn5'] = output['fqn6_ev']/output['fqn5_sales_guid']
    output['guid_sales_to_ev_qn6'] = output['fqn7_ev']/output['fqn6_sales_guid']
    output['guid_sales_to_ev_qn7'] = output['fqn8_ev']/output['fqn7_sales_guid']
    
    z = output[['guid_sales_to_ev_q1', 
'guid_sales_to_ev_q0',
'guid_sales_to_ev_qn1',
'guid_sales_to_ev_qn2',
'guid_sales_to_ev_qn3',
'guid_sales_to_ev_qn4',
'guid_sales_to_ev_qn5',
'guid_sales_to_ev_qn6', 'guid_sales_to_ev_qn7']]
