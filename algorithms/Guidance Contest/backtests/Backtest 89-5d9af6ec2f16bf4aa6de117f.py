...
def before_trading_start(context, data):
    ...
    # output.loc[output['guidance_days_prev'] < 5, 'flag'] = np.maximum(0, d_5)
    # np.exp(np.minimum(0, d_5*0.4))
    
    # d_40 = 40 - output['guidance_days_prev']
    # output.loc[output['guidance_days_prev'] > 40, 'flag'] = np.exp(np.minimum(0, d_40)/5)
