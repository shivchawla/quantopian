...
def before_trading_start(context, data):
    ...
    output['flag'] = 0.0 
    # output['guidance_days_prev'] < DAYS_MAX
    output.loc[output['guidance_days_prev'] < DAYS_MAX, 'flag'] = 1.0
    ...
    # print guid_eps_std
    alpha1_g = signalize(-guid_eps_std)
...
def record_vars(context, data):
    ...
    record("5-4", context.alpha5.corr(context.alpha4))
