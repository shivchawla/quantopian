...
def before_trading_start(context, data):
    ...
    # alpha1_g_org = signalize(-guid_eps_std)
...
'guid_sales_to_mcap_qn6', 'guid_sales_to_mcap_qn7']]).mean(axis=1)
    ...
    alpha6_ga = signalize(-sls_surprise_per_share_std)
    
    # print "Corr (old/New)"
    # print (alpha1_g+alpha6_ga).corr(alpha1_g_org + alpha2_g + alpha3_gc + alpha4_g)
    # print alpha1_g.corr(alpha1_g_org)
    
    output['signal_rank'] = alpha1_g + alpha6_ga
