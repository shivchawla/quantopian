...
def make_pipeline():
    ...
    guidance_days_next = BusinessDaysUntilNextEvent(inputs=[fe.Guidance.slice('SALES', 'qf', 2).asof_date])  
...
def before_trading_start(context, data):
    ...
    # print "Corr (old/New)"
    # print (alpha1_g+alpha6_ga).corr(alpha1_go + alpha2_g + alpha3_gco + alpha4_g)
    # print (alpha1_g+alpha6_ga+alpha3_gc).corr(alpha1_go + alpha2_g + alpha3_gco + alpha4_g)
