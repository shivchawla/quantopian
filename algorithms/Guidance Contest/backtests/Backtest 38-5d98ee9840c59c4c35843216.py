...
def before_trading_start(context, data):
    ...
    print output['flag'].sort_values(ascending=False)
    ...
    z21 =     output['flag']*(output['fq1_sales_guid'] - output['fq0_sales_guid'])/output['fq0_sales_guid']
    z22 =     output['flag']*(output['fq1_sales_guid'] - output['fqn1_sales_guid'])/output['fqn1_sales_guid']
    z23 =     output['flag']*(output['fq1_sales_guid'] - output['fqn2_sales_guid'])/output['fqn2_sales_guid']
    
    context.z2 = z21.count()
    alpha2_g = (signalize(z21) + signalize(z22) + signalize(z23))/3           
...
'guid_sales_to_mcap_qn6', 'guid_sales_to_mcap_qn7']]).mean(axis=1)
    ...
    context.z4 = z4.count()
    alpha4_g = signalize(z4*output['flag'])
    ...
    output['signal_rank'] = (alpha1_g + alpha2_g + alpha4_g + (alpha3_gc + alpha5_g + alpha6_ga)/3)
...
def record_vars(context, data):
    ...
    record("1-3", context.alpha1.corr(context.alpha3))
    record("2-3", context.alpha2.corr(context.alpha3))
    record("4-3", context.alpha4.corr(context.alpha3))
    record("5-3", context.alpha5.corr(context.alpha3))
    record("6-3", context.alpha6.corr(context.alpha3))
