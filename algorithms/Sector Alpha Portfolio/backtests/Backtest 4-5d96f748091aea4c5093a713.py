...
#Compute Sectoral Market Cap
    ...
    for x in range(1, 16):
        wfname = 'weightedFactor' + str(x)
        agg_sector_[wfname] = agg_sector_[wfname]/agg_sector_['mkt_cap']
...
# - data['alpha9'] - data['alpha13'] + data['alpha15'])/6
    ...
    net_alpha = (data['alpha4'] + data['alpha5'] + data['alpha9'])/3

    
    print "Net Alpha"
    print net_alpha
    
    # output['signal_rank'] = net_alpha
    # alpha_c #ra/nAlphaFactors
    context.alpha = net_alpha #output['signal_rank']
